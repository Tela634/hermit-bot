...
module.exports = {
  ...
  BLOCKCHAT: process.env.BLOCK_CHAT || true,
  LANG: (process.env.LANGUAGE || 'EN').toUpperCase(),
  ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE),
  BOT_NAME: process.env.BOT_NAME || '『➪𝙡𝘦𝘴𝘵𝘢♕𝙚𝙡𝙞𝙪𝙙✔𝙗𝙤𝙩』',
  ...
  ANTILINK_MSG: process.env.ANTILINK_MSG || '_Link Not Allowed 𝙍𝙀𝘼𝘿 𝙂𝙍𝙊𝙐𝙋 𝙍𝙐𝙇𝙀𝙎⌫!_\n_(Change this by setting var ANTILINK_MSG)_',
  BOT_INFO: process.env.BOT_INFO || '𝘓𝘌𝘚𝘛𝘈;𝘌𝘓𝘐𝘜𝘋;254701309409;https://i.imgur.com/6oRG106.jpeg',
  AUDIO_DATA: process.env.AUDIO_DATA || '𝘭𝘦𝘴𝘵𝘢;𝘦𝘭𝘪𝘶𝘥;https://i.imgur.com/fj2WE83.jpeg',
  STICKER_DATA: process.env.STICKER_DATA || '𝘭𝘦𝘴𝘵𝘢;𝘦𝘭𝘪𝘶𝘥',
